            ...
            <div class="progress-container bg-white rounded-30 p-sm-5 p-3 mb-3">
                <div class="d-md-flex mb-4">
                    <div class="align-self-center mb-3">
                        <h2 class="primary_title text-black ">Section List</h2>
                    </div>
                    <div class="ms-auto ">
                        <p>
                            {{--<span><i class="fa-solid fa-filter filter_icon me-3"></i></span>
                            <span class="sort_by">Sort by: Popular Class</span>--}}
                            <a class="sort_by" id="" href="{{ route('section.create') }}">Add Section</a>
                        </p>
                    </div>
                </div>
                            ...
                            <table id="example1" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <a href="{{ route('section.edit', $row->id) }}" class="btn btn-info btn-sm"><i
                                        ...
                                        <a href={{route('section.delete',$row->id) }} onclick="return confirm('Are you sure You want to delete this Item?')" class="btn btn-danger btn-sm"><i
