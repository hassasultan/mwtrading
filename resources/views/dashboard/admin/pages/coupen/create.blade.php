                ...
                <div class="progress-container bg-white rounded-30 p-sm-5 p-3 mb-3">
                    <div class="d-md-flex mb-4">
                        <div class="align-self-center mb-3">
                            <h2 class="primary_title text-black ">Add Coupen</h2>
                        </div>
                        <div class="ms-auto ">
                            <p>
                    ...
                    <form class="needs-validation" method="post" action="{{ route('coupen.store') }}" novalidate>
                        @csrf
                        <div class="form-row">
